...
{!!HTML::script('js/sweetAlert/qrcode.js') !!}
    ...
    <!-- {!!HTML::script('js/sweetAlert/addImage.js') !!}-->
    {!!HTML::script('js/sweetAlert/jquery.plugin.html2canvas.js') !!}
    <!-- Twitter Bootstrap -->
...
var 	//form = document.querySelectorAll(".pdfprint"),
        form = $('#pdfprint'),
...
function createPDF(){
	...
	var img = canvas.toDataURL("image/png"),
        ...
        //window.open(img);
        doc.text(35, 20, '{{ trans("booking/labels.label9")}}');
